package ict_trainings.ictapp.courses.course.json;
...
public class Course {
    ...
    public static List<ict_trainings.ictapp.courses.course.model.Course> parseCourse(String content){
        try {
            Log.d(TAG, content);
            JSONArray jsonArray = new JSONArray(content);
            List<ict_trainings.ictapp.courses.course.model.Course> courseList = new
                    ArrayList<>();

            for(int i = 0; i < jsonArray.length(); i++){

                JSONObject jsonObject = jsonArray.getJSONObject(i);
                ict_trainings.ictapp.courses.course.model.Course course = new
                        ict_trainings.ictapp.courses.course.model.Course();
...
//                course.setCourseCharges(jsonObject.getString("charges"));
                ...
                course.setLink_pdf(jsonObject.getString("link_pdf"));
