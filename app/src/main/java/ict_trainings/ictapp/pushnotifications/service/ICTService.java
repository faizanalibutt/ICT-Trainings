...
import ict_trainings.ictapp.splash.Splash;

public class ICTService extends FirebaseMessagingService {
...
//            Log.e(TAG, "Data Payload: " + remoteMessage.getData().toString());
    ...
    private void handleNotification(String message) {
        if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
            ...
            // TODO: 5/3/2017 handle it when app in background no text displayed on screen
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                ...
                // TODO: 5/20/2017 when app in background
                Intent resultIntent;
                // app is in background, show the notification in notification tray
                if(type.equals(Config.TOPIC_EVENTS)){
